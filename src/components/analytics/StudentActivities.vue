        ...
        <div class="col-12">
            ...
            <div class="col-md-4">
              <div class="card">
                <div class="card-body text-center">
                  ...
                  <h3 class="mb-0">{{ stats.activeStudents }}</h3>
                  <p class="text-muted mb-0">دانش‌آموزان فعال</p>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card">
                <div class="card-body text-center">
                  ...
                  <h3 class="mb-0">{{ stats.averageProgress }}%</h3>
          ...
          <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
              ...
              <div>
                <select class="form-select" v-model="selectedCourse" @change="fetchStudentActivities">
                ...
                <div v-else class="table-responsive">
                  <table class="table table-hover">
                    ...
                    <tr v-for="(student, index) in students" :key="student.id">
                      ...
                      <td>
                          <span class="badge" :class="getStatusBadge(student.status)">
  ...
  setup() {
    ...
    const fetchCourses = async () => {
      try {
        ...
        // If courses are loaded and no course is selected, fetch activities for all courses
    ...
    const fetchStudentActivities = async () => {
      if (!selectedCourse.value) {
        // If no course selected, fetch stats for all courses
        try {
    ...
    const viewProgress = async (student) => {
      ...
      try {
        ...
        // For now, show basic progress info
